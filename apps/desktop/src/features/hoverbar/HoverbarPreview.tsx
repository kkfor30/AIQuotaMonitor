...
const gptPlatform: PlatformSummaryViewModel = {
  ...
  sources: [
    source("openai-codex-local", "本机 Codex", ["quota_window_5h", "quota_window_7d", "banked_reset_count", "credits", "plan_level"], "local_cli"),
    source("openai-codex-extra-2", "额外 ChatGPT 账号 2", ["quota_window_30d", "banked_reset_count", "credits", "plan_level"], "local_cli"),
  ...
  capabilities: [
    ...
    cap("banked_reset_count", "openai-codex-local", "本机 · 可用重置卡", "0", "当前没有可用重置卡"),
    ...
    cap("banked_reset_count", "openai-codex-extra-2", "账号 2 · 可用重置卡", "1", "可用于重置 Codex 使用额度"),
