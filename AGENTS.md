...
9. 扩平台任务再读 `docs/project/GLM-ADD-PLATFORMS.md`；国内优先再读 `docs/project/GLM-ADD-DOMESTIC-PLATFORMS.md`
...
- `D:\AIproject\DeepSeekMonitorWindows-final` 与 `D:\AIproject\cc-switch` 仅作为本机只读参考，不得在本项目任务中修改。
- 不提交 `node_modules`、`dist`、Rust `target`、IDE 配置、日志或任何凭据。

## 交付与文档

- 每次完成一个可识别阶段，更新 `docs/project/handoff.md`、`docs/project/roadmap.md` 和 `docs/iterations.md`。
